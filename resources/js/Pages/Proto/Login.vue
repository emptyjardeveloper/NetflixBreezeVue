    ...
    <div class="mx-auto max-w-screen min-h-screen bg-black text-white md:px-10 px-3">
        ...
        <div class="py-24 flex laptopLg:ml-[680px] laptopXl:ml-[870px]">
            <div>
                ...
                <form class="w-[370px]" @submit.prevent="submit">
                    <div class="flex flex-col gap-6">
                        <div>
                            <InputLabel for="email" value="Email" />
                            <TextInput id="email" type="email" v-model="form.email" required autocomplete="off"
                                placeholder="Email" />
                        </div>
                        <div>
                    ...
                    <div class="grid space-y-[14px] mt-[30px]">
                        ...
                        <SecondaryButton>
                            <Link href="signup" preserve-scroll>Create Account</Link>
                        </SecondaryButton>
                    </div>
                </form>
            </div>
